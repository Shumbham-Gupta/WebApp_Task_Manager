    ...
    <div className="min-h-screen  py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-black mt-2 text-md">Manage your tasks and stay productive</p>
        </div>
        ...
        <div className="bg-white border border-blue-100 p-4 rounded-lg shadow-sm mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <button
              ...
              className="bg-purple-600 hover:bg-purple-800 text-white px-4 py-2 rounded-md shadow flex items-center whitespace-nowrap"
            >
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-800 text-lg">No tasks found. Create your first task!</p>
          </div>
        ) : (
